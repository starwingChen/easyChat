...
export const mockHistorySnapshots = [
  {
    ...
    messages: [
      ...
      },
      {
        ...
        content:
          'React favors explicit composition and ecosystem choice, whereas Vue emphasizes approachability and cohesive defaults.',
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        botId: 'chatgpt',
        modelId: 'gpt-4-turbo',
        content: 'Build an AI pet behavior coach that turns camera footage into daily training tips.',
        createdAt: '2026-03-25T00:00:01.000Z',
        status: 'done',
      },
      {
        ...
        content: 'Offer a multimodal health journal that combines meals, activity, and photo-based symptom tracking.',
        createdAt: '2026-03-25T00:00:02.000Z',
        status: 'done',
      },
      {

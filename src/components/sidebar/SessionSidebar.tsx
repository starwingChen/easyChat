      ...
      <aside className="flex w-[198px] shrink-0 flex-col border-r border-slate-200 bg-slate-50/80">
        ...
        <div className="mx-3 mb-3">
          <button
            ...
            className="flex w-full items-center justify-center rounded-xl border border-slate-200 bg-white px-3 py-3 text-slate-600 transition hover:border-slate-300 hover:bg-slate-100 hover:text-slate-900"

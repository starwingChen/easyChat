const zhCNMessages = {
  ...
  'sidebar.settings.shortcutsDefault': '默认快捷键：Windows 为 Alt+J，macOS 为 Option+J',
  ...
  'bot.replyTemplate.chatgpt': 'ChatGPT（{model}）会从结构化角度回答：“{prompt}”。',
  ...
  'bot.error.chatgpt.authRequired': 'ChatGPT 需要登录，请前往 [https://chatgpt.com](https://chatgpt.com) 登录后再试。',
